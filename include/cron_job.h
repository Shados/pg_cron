...
#define Natts_at_job 7
#define Anum_at_job_jobid 1
#define Anum_at_job_timestamp 2
#define Anum_at_job_command 3
#define Anum_at_job_nodename 4
#define Anum_at_job_nodeport 5
#define Anum_at_job_database 6
#define Anum_at_job_username 7
